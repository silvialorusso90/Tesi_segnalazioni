...
//https://www.youtube.com/watch?v=KaDwSvOpU5E
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(CameraActivity.this, "click camera btn", Toast.LENGTH_SHORT).show();
        ...
        galleryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Toast.makeText(CameraActivity.this, "click gallery btn", Toast.LENGTH_SHORT).show();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                image.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        Log.i("tag", "onSuccess: Uploaded Image URl is " + uri.toString());
                        /*Intent i = new Intent(CameraActivity.this, ProfiloActivity.class);
                        startActivity(i);
